...
class SongHiBaiListAdapter(private var songList: List<Song>, private var operationListener: OperationListener) : RecyclerView.Adapter<SongHiBaiListAdapter.SongHiBaiHV>() {
    ...
    class SongHiBaiHV(itemView: View, private var operationListener: OperationListener) : RecyclerView.ViewHolder(itemView) {
        fun initViewDate(song: Song) {
            ...
            itemView.findViewById<RelativeLayout>(R.id.rl_song_operation).setOnClickListener {
